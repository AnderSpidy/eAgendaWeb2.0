...
namespace eAgenda.webapi.Controllers
{
    ...
    public class AutenticacaoController : eAgendaControllerBase
    {
        ...
        public AutenticacaoController(ServicoAutenticacao servicoAutenticacao, IMapper mapeadorUsuario)//ja ira mapear as propriedades do objeto Usuario
        {
        ...
        {
            //traduzindo, a partir do mapeador do Usuario, Crie o usuarioVM
